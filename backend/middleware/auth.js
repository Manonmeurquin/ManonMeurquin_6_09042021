...
module.exports = (req, res, next) => {
  try {
    ...
    const decodedToken = jwt.verify(token, 'RANDOM_TOKEN_SECRET'); // Décoder, vérifier le token avec le package et la clé secrète qui doit correspondre à celle de la fonction login
